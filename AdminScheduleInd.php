...
<<<<<<< HEAD
	      <input id="Date" type="date" name="Date" placeholder="mm/dd/yyyy" min="2015-08-01" max="2015-12q-31" required autofocus> (mm/dd/yyyy)
=======
...
>>>>>>> bcc46b3a4bcc869f0cdd8346d6af601ba231d543
	...
	<!--specifying how many weeks to repeat for-->
        <div class="field">
        	<h3>Repeat for
