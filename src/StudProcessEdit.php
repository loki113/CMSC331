...
/* $_SESSION["email"] = $_POST["email"]; // saves student's email */ // Not using a session variable for email anymore, so no need to save it to one
/* $_SESSION["major"] = $_POST["major"]; // saves student's major */ // Not using a session variable for major anymore, so no need to save it to one
