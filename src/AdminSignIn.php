  ...
  <body>
    ...
    ?>
	    ...
	    <div class="field">
	      ...
	      <input id="UserN" size="20" maxlength="50" type="text" name="UserN" required autofocus> <!--enter username here-->
	    </div>

	    <div class="field">
	      <label for="PassW">Password</label>
	      <input id="PassW" size="20" maxlength="50" type="password" name="PassW" required> <!--enter password here-->
	    </div>
