  ...
  <body>
    <div id="login">
      <div id="form">
	    ...
	    <?php
			// retrieves all advisors and displays their names with radio buttons
		...
		<!-- button to continue to select appointment time with advisor -->
		...
		<div>
		<!-- button to cancel scheduling and return home -->
