...
<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
	      ...
	      <input id="Date" type="date" name="Date" placeholder="mm/dd/yyyy" min="2015-08-01" max="2015-12-31" required autofocus> (mm/dd/yyyy)
	...
	<!--check to apply to multiple weeks-->
        <div class="field">
	...
	<!--specifying for how many weeks to repeat-->
        <div class="field">
        	<h3>Repeat for
	...
	<!--specifying capacity for appointment-->
	<div class="field">
        	<h3>Student limit: 
