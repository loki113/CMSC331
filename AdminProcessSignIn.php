...
$_SESSION["UserN"] = strtoupper($_POST["UserN"]); // saves admin's username in all caps
$_SESSION["PassW"] = strtoupper($_POST["PassW"]); // saves admin's password in all caps
$_SESSION["UserVal"] = false;

$user = $_SESSION["UserN"];
$pass = $_SESSION["PassW"];

$sql = "SELECT * FROM `Proj2Advisors` WHERE `Username` = '$user' AND `Password` = '$pass'"; // finds advisor
